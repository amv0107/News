...
object Retrofit {
    ...
    const val scalersConvertors = "com.squareup.retrpfit2.converter-scalars:${Versions.scalerConvertor}"
}
...
object LottieAnimations {
    const val lottienAnimations = "com.airbnb.android:lottie:${Versions.lottieAnimations}"
}